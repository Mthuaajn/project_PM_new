document.addEventListener("DOMContentLoaded", function () {
    ...
    function filterCustomerList(searchTerm) {
        ...
        rows.forEach((row) => {
            ...
            if (maKhachHang.includes(searchTerm) || hoTen.includes(searchTerm) || diaChi.includes(searchTerm) || email.includes(searchTerm) || dienThoai.includes(searchTerm) || tienNo.includes(searchTerm)) {
                row.style.display = "";
            } else {
